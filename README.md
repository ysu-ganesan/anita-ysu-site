...
6. **Later on 25 Sep: the glitch, and her eyes on the left.**
   ...
   - **Her eyeballs follow the cursor on the left.** In J's take, her head turns left (frames 67–82) but her eyes stay on the camera. In frames 67–81 only her eyeballs now move. The inside of each eye opening (white and iris) comes from the right-turn frame with the same amount of turn, mirrored so it looks left. It is reshaped to fill her own opening exactly, corner to corner and lid to lid. Her lids, lashes, corners, brows, hair and face stay as J drew them. Frame 82 and the centre are unchanged. The first try swapped her whole eyes and was rejected, because her eye shape changed; so was sliding her irises row by row, which broke up eyes this small.
   - **One pass from J's originals.** The gaze sheets are rebuilt from J's originals in one pass (white patch, halo, eyeballs), so his frames are re-compressed only once.
